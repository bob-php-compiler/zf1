...
class Zend_Controller_Action_Helper_ViewRendererTest extends PHPUnit_Framework_TestCase
{
     ...
     * @return array
     */
    public function dataProviderTestViewScriptNameDoesNotIncludeDisallowedCharacters()
    {
        return array(
            array('myBar-'),
            array('-myBar'),
     ...
     * @return array
     */
    public function dataProviderTestControllerNameDoesNotIncludeDisallowedCharacters()
    {
        return array(
            array('!index'),
            array('@index'),
