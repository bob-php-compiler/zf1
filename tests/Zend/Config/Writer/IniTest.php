...
class Zend_Config_Writer_IniTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $config = new Zend_Config_Ini(TEST_ROOT_DIR . '/Zend/Config/Writer/files/allsections.ini', null, array('skipExtends' => true));
    ...
    {
        $config = new Zend_Config_Ini(TEST_ROOT_DIR . '/Zend/Config/Writer/files/allsections.ini', 'staging', array('skipExtends' => true));
