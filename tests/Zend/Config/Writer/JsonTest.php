...
class Zend_Config_Writer_JsonTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_tempName = tempnam(TEST_ROOT_DIR . '/Zend/Config/Writer/temp', 'tmp');
    }
    ...
    {
        $config = new Zend_Config_Json(TEST_ROOT_DIR . '/Zend/Config/Writer/files/allsections.json', null, array('skip_extends' => true));
    ...
    {
        $config = new Zend_Config_Json(TEST_ROOT_DIR . '/Zend/Config/Writer/files/allsections.json', 'staging', array('skip_extends' => true));
    ...
    {
        $config = new Zend_Config_Json(TEST_ROOT_DIR . '/Zend/Config/Writer/files/allsections-pretty.json');
