...
class Zend_Http_Header_SetCookieTest extends PHPUnit_Framework_TestCase
{
    ...
    public function dataProviderTestGetFieldValue()
    {
    ...
    public function dataProviderTestAddingAsRawHeaderToResponseObject()
    {
        return $this->validCookieWithInfoProvider();
    }
    ...
    public function dataProviderTestDoesNotAllowCRLFAttackVectorsViaSetters()
    {
        return $this->invalidCookieComponentValues();
    }
